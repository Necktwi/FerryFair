...
public:
	...
	size_t stringify(std::string& out, const std::string& skipClass = "",
						  const std::string& mustClass = "") const;
	size_t calculateLength(const std::string& skipList,
								  const std::string& mustList) const;
	void stringifyHelper(std::string& out, const std::string& skipList,
								const std::string& mustList) const;
